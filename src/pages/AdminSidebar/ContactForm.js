...
const ContactForm = (props) => {
    ...
    return (
        <form autoComplete="off" onSubmit={handleFormSubmit}>
            ...
            <div className="form-group">
                <Button className="rounded-pill my-3" type="submit" color="secondary-blue" value={props.currentId === '' ? "Save" : "Update"} style={{ backgroundColor: "blue", color: 'white', borderColor: "blue", }}> Save</Button>
